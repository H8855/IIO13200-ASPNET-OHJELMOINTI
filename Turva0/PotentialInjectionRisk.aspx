...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <p>tänään on:<asp:TextBox ID="txtDate" runat="server" Enabled="false" Text="..."></asp:TextBox>
  <asp:Button ID="btnAddToMySQL" runat="server" Text="Lisää kantaan" OnClick="btnAddToMySQL_Click" /></p>
  <h2>Kommentit</h2>
  <!-- mysql datasources -->
